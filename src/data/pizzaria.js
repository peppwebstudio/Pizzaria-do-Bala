...
export const REVIEWS = [
  {
    name: "Clara Melo",
    initials: "CM",
    text: "Melhor pizza da região! Amo a pizza de frango com catupiry! O catupiry é de primeira qualidade, além dos sachês de katchup, maionese e mostarda serem da marca Heinz. Amooo",
    role: "Avaliação Google Maps",
  },
  {
    name: "Rafael Arcoverde",
    initials: "RA",
    text: "Incrível!! Pizza maravilhosa, massa fina e muito bem preparada! E o dono é uma figura, gente finissima!",
    role: "Avaliação Google Maps",
  },
  {
    name: "Monique Silva",
    initials: "MS",
    text: "A melhor pizza da Boa Vista. Massa fininha, boa quantidade de recheio, é uma massa que não deixa empachado. O atendimento é rápido e eficiente, a entrega é bem rápida também.",
    role: "Avaliação Google Maps",
  },
  {
    name: "Edmar",
    initials: "E",
    text: "Melhor pizza do bairro Boa Vista",
    role: "Avaliação Ifood",
  },
  {
    name: "Iasmin",
    initials: "I",
    text: "Eu pedi a pizza pelo hits e não estava esperando muita coisa, mas estava uma delícia!! Veio quentinha, a massa é fininha e bem recheada, a calabresa também é de boa qualidade. Amei!",
    role: "Avaliação Ifood",
  },
  {
    name: "Aline",
    initials: "A",
    text: "Pizza muito saborosa sempre",
    role: "Avaliação Ifood",
  },
];
